...
import "./index.css";
import image from "../AllImage/school-logo.jpg";
      ...
      <div className="footer-inner">
        ...
        <section className="footer-section" aria-labelledby="footer-about-title">
          <h2 className="brand-name" id="footer-about-title">
            <img className="school-logo" src={image} alt="school logo" />
            LBMDPS Naitand
          </h2>
          <p className="about-text">
            Nurturing young minds with excellence in education, character
            building, and holistic development since 1995.
          </p>

          <nav className="social-links" aria-label="Social media links">
            <a href="https://www.facebook.com/" aria-label="Facebook" title="Facebook" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.instagram.com/" aria-label="Instagram" title="Instagram" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.youtube.com/" aria-label="Youtube" title="YouTube" target="_blank" rel="noopener noreferrer">
        ...
        <section className="footer-section" aria-labelledby="footer-quicklinks-title">
          <h2 className="footer-heading" id="footer-quicklinks-title">
            Quick Links
          </h2>
        ...
        <section className="footer-section" aria-labelledby="footer-contact-title">
          ...
          <address>
            <div className="contact-item">
              Village Naitand, District Giridih, Jharkhand - 815316
            </div>
            <div className="contact-item">
              📞 <a href="tel:+919876543210">+91 98765 43210</a>
            </div>
            <div className="contact-item">
              ✉️ <a href="mailto:info@lbmdps.edu.in">info@lbmdps.edu.in</a>
            </div>
            <div className="contact-item">⏰ Mon - Sat: 8:00 AM - 4:00 PM</div>
          </address>
        </section>
